...
var formSubmit = document.querySelector(".contest-form__submit-btn");
var popup = document.querySelector(".popup");
var popupError = document.querySelector(".popup--error");
var popupSuccess = document.querySelector(".popup--success");
var popupErrorButton = popup.querySelector(".popup__error-btn");
var popupSuccessButton = popup.querySelector(".popup__success-btn");
